...
MONGO_URI = "mongodb://172.24.0.179:27017/?directConnection=true&serverSelectionTimeoutMS=5000&appName=mongosh+2.3.3"

# SQL Server connection string for a Docker container (example)
SQL_SERVER_CONN_STR = "Driver={ODBC Driver 18 for SQL Server};Server=172.17.0.2,1433;Database=forAirflow;UID=sa;PWD=Valuetech@123"
