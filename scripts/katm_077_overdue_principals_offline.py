...
write_to_table = 'bronze.katm_077_overdue_procents_offline'
...
query = {
    'reports.077.open_contracts.open_contract.overdue_principals.overdue_principal': {'$exists': True}
    ,'time': {'$gt': datetime(2023, 1, 1)}
    ,'time':{'$lt':datetime(2024, 1, 1)}
    # ,'number': {'$eq': 8141290}
    # ,'number': {'$gt': max_num}
...
projection = {
    '_id': 1,
    'reports.077.open_contracts.open_contract.overdue_principals.overdue_principal': 1
}
