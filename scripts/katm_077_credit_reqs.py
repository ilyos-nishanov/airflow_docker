...
start = time()
write_to_table='bronze.katm_077_credit_reqs'
...
for doc in docs:
    ...
    fields = doc.get('data', {}).get('katm_077', {}).get('return', {}).get('data', {}).get('credit_requests', {}).get('credit_request', [])
